...
public class BTreeLeafPageTest extends SimpleDbTestBase {
    ...
    public void getLeftSiblingId() throws Exception {
        BTreeLeafPage page = new BTreeLeafPage(pid, EXAMPLE_DATA, 0);
        assertNull(page.getLeftSiblingId());
    }
    ...
    public void getRightSiblingId() throws Exception {
        BTreeLeafPage page = new BTreeLeafPage(pid, EXAMPLE_DATA, 0);
        assertNull(page.getRightSiblingId());
    }
    ...
    public void testIterator() throws Exception {
        ...
        tuples.sort(new TupleComparator(0));
        ...
        for (int i = 0; i < free; ++i) {
            ...
            while (it.hasNext()) {
                ...
                if (TestUtil.compareTuples(addition, tup)) {
                    ...
                    assertEquals(page0.getId(), tup.getRecordId().getPageId());
                    break;
                }
            }
            assertTrue(found);
